...
[Project](../../../../index.md) > [SQLserver](../../../index.md) > [User databases](../../index.md) > [MTPData](../index.md) > [Views](Views.md) > dbo.viewReviewScopeElements

# ![Views](../../../../Images/View32.png) [dbo].[viewReviewScopeElements]
...
| Created | 9:37:46 AM Tuesday, April 29, 2025 |
| Last Modified | 9:01:47 AM Friday, May 16, 2025 |
...
| RevisionID | int | 4 |
| MTPID | int | 4 |
| New Roadway Facility | int | 4 |
| Roadway Relocation | int | 4 |
| Add or Remove General Purpose Capacity Lanes | int | 4 |
| Add General Purpose Capacity Lanes | int | 4 |
| Remove General Purpose Capacity Lanes | int | 4 |
| Change Roadway Usage/Operations | int | 4 |
| Add or Remove Business Access Transit Lanes | int | 4 |
| Add or Remove High Occupancy Vehicle Lanes | int | 4 |
| New Interchange | int | 4 |
| Interchange Improvements | int | 4 |
| Intersection Improvements | int | 4 |
| Road Resurfacing/Rehabilitation | int | 4 |
| Grade Separation | int | 4 |
| Bridge Replacement or Rehabiltation | int | 4 |
| New or Widened Bridge | int | 4 |
| Park & Ride | int | 4 |
| New or Relocated Transit Center or Station | int | 4 |
| Transit Center or Station Improvement | int | 4 |
| New High Capacity Transit Alignment | int | 4 |
| Interstate Bus Flyer Stop | int | 4 |
| Transit Amenities | int | 4 |
| Transit Maintenance and Operation Base | int | 4 |
| Vehicle Purchase | int | 4 |
| New Ferry Route | int | 4 |
| Change to Existing Ferry Service | int | 4 |
| New or Relocated Ferry Terminal | int | 4 |
| Ferry terminal improvement | int | 4 |
| Ferry vessel purchase or maintenance | int | 4 |
| Bike/Pedestrian Trail or Path | int | 4 |
| Other Bike/Pedestrian Path | int | 4 |
| Bike Lane | int | 4 |
| Sidewalk | int | 4 |
| Bike/Pedestrian Bridge | int | 4 |
| Other Bicycle/Pedestrian Improvements | int | 4 |
| Intelligent Transportation System | int | 4 |
| Transportation Demand Management | int | 4 |
| Other Preservation/Maintenance | int | 4 |
